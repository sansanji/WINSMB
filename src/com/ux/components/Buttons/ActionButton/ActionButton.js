 ...
 * 엑션 버튼 컴포넌트
 */
// 참조 사이트 : https://github.com/mastermoo/react-native-action-button
  ...
  _renderActions() {
    ...
    return (
      <View style={actionStyle} pointerEvents={'box-none'}>
        {actionButtons.map(ActionButtonConfig => (
          <ActionButtonItem
            key={ActionButtonConfig.props.title}
            anim={this.anim}
            {...this.props}
            ...
            onPress={() => {
              ...
              ActionButtonConfig.props.onPress();
            }}
          />
        ))}
      </View>
      ...
      <View pointerEvents="box-none" style={[this.getOverlayStyles(), this.props.style]}>
        <Animated.View
          ...
          style={[
            ...
            {
              backgroundColor: bluecolor.basicBluelightColor, // this.props.bgColor,
              opacity: this.anim.interpolate({
                inputRange: [0, 1],
                outputRange: [0, 0.25], // this.props.bgOpacity],
              }),
            },
          ]}
        >
...
ActionButton.defaultProps = {
  ...
  buttonColor: 'rgba(52,152,219,0.8)',
