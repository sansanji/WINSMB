      ...
      <HBaseView style={styles.container}>
        <HFormView>
          ...
          <HRow>
            ...
            <HTextfield label={'Ref.Doc No.'} value={this.state.data.GI_REF_DOC_NO} bold />
          </HRow>
          <HRow>
          ...
          <HRow>
            ...
            <HNumberfield label={'C/T Qty'} value={this.state.data.T_GI_CT_QTY} />
          </HRow>
          <HRow>
          ...
          <HRow>
            <HTextfield label={'Name'} value={this.state.data.GI_CONFIRM_USER_NAME} />
