...
class Component extends NavigationScreen {
  ...
  componentWillMount() {
    modelUtil.setModelData('DMS100101', {
      GR_DT: 'Y',
      PLT_CHECK: 'N',
      BOX_CHECK: 'N',
      ITEM_CHECK: 'N',
  ...
  _onPress(item, grgiFlag) {
    ...
    const checkData = modelUtil.getModelData('DMS100101');
    if (grgiFlag === 'GR') {
  ...
  async focusNextField(scanData) {
    ...
    let reqService = 'DMS030050SVC';
    let reqKey = 'DMS030050F1';
    let resKey = 'DMS030050G1';
    let param = {
      WH_CODE: whCode,
      // GR_DATE_FROM: date,
      // GR_DATE_TO: date,
